...
/**
 * Test case of the TCVWriterTest class
 *
 * @author e.umeda
 */
public class TSVWriterTest {
    ...
    public void Instanciate_Test() throws IOException {
        String path = "c:\\tools\\test.tsv";
        writer = new TSVWriter(path);

        assertThat(writer, is(instanceOf(TSVWriter.class)));
    }
    ...
    public void Instanciate_IOException_Test() {
        String invalid_test_Path = "c:\\bar\\foo\\write_test.tsv";
        try {
            writer = new TSVWriter(invalid_test_Path);
        } catch (Exception e) {
    ...
    public void writerow_IOException_Test() {
        String testPath = "c:\\tools\\write_test.tsv";
        ...
        try {
            ...
            writer = new TSVWriter(testPath);
            //inject OutputStreamWriter to the TCVWriter
    ...
    public void replaceQuote_Test() throws Exception {
        ...
        Method method = TSVWriter.class.getDeclaredMethod("replaceQuote", String.class);
    ...
    public void buildModRowData_Test() throws Exception {
        ...
        Method method = TSVWriter.class.getDeclaredMethod("buildModRowData", String.class);
        method.setAccessible(true);
    ...
    public void convertStr_Test() throws Exception {
        ...
        writer = new TSVWriter(path, decode);

        Method method = TSVWriter.class.getDeclaredMethod("convertStr", String.class);
        method.setAccessible(true);
